# 🛠️ Outils Utilisés - Ascension WoW Security Assessment

## 📊 Résumé
Total d'outils: **17+**
Langages: **C, Python, Bash, Markdown**
Durée: **20+ heures**
...
### **x32dbg**
- **Usage:** Debugging dynamique du client Ascension.exe
- **Fonctionnalités utilisées:**
...
### **Winsock2 Hooks**
- **Usage:** Interception trafic réseau
- **Protocoles:** TCP/IP (WoW protocol)
- **Stats:** 11,645 paquets, ~2.8 MB de données
...
### **Markdown**
- **Rapports créés:**
  - ASCENSION_SECURITY_REPORT.md (604 lignes)
...
- **Output:** ASCENSION_SECURITY_REPORT.html
...
- **Archives:** Ascension_Security_Package_v2.tar.gz (394 KB)
